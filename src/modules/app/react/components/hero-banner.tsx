export default function HeroBanner() {
  return (
    <div className="relative h-[500px] w-full bg-gradient-to-r from-pink-50 to-purple-50 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-between px-12">
        {/* Left Content */}
        <div className="z-10 max-w-lg space-y-6 animate-slide-in-left">
          ...
          <button className="rounded-full bg-black px-8 py-3 font-semibold text-white transition-all duration-300 hover:bg-gray-800 hover:scale-105 active:scale-95">
            ACHETER MAINTENANT
          </button>
        </div>

        {/* Right Image - Placeholder with gradient */}
        <div className="relative h-[450px] w-[500px] overflow-hidden rounded-2xl shadow-2xl animate-slide-in-right">
